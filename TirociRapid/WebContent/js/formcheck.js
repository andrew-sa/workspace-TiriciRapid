...
function validateModificaDatiAziendali(form) {
	var contr = 0;
	resetInput(form);
...
function validateCurriculum(form) {
	...
	if (!(form["madrelingua"].value.trim().match(/^[A-Za-z]{2,20}$/))) {
		form["madrelingua"]
				.setAttribute("title",
						"La tua madreLingua non \u00E8 nel formato corretto");
		document.getElementById(8).innerHTML = "La tua madreLingua non \u00E8 nel formato corretto";
		contr = 1
	}
