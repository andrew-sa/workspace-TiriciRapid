...
<body>
	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
			...
			<li role="presentation" id="attiva"><a href="#">Richieste di
					tutorato</a></li>
					<li role="presentation" ><a href="responsabileApprovazioniRichiesteNuoviTirocini.jsp">Richieste nuovi tirocini</a></li>
