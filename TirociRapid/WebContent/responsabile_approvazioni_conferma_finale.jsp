				...
				<div class="row">
					<div class="col-md-9 cta-contents">
						...
						<div class="cta-desc">
							...
							<h3>Professore:</h3>
							<p>
							<%=reqTir.getTutorInterno().getUsername() %>
							</p>
							<h3>Azienda:</h3>
							<p>
					...
					<% 
					String pathAccetta ="convalida_richiesta_tirocinio?tipoRichieste=all&action=accetta&partitaIVAAzienda="+reqTir.getTirocinio().getPartitaIVAAzienda()+
										"&nomeTirocinio="+reqTir.getTirocinio().getNome()+"&usernameStudente="+reqTir.getStudente().getUsername();
					String pathRifiuta ="convalida_richiesta_tirocinio?tipoRichieste=all&action=rifiuta&partitaIVAAzienda="+reqTir.getTirocinio().getPartitaIVAAzienda()+
							"&nomeTirocinio="+reqTir.getTirocinio().getNome()+"&usernameStudente="+reqTir.getStudente().getUsername();
					%>
						<a href="<%=pathAccetta%>" class="btn btn-lg btn-block btn-default bottone-professore-accetta" style="display: block;">Accetta</a>
					</div>
					<div class="col-md-3 cta-button" >
						<a href="<%=pathRifiuta%>" class="btn btn-lg btn-block btn-default bottone-professore-rifiuta"  style="display: block;" >Rifiuta</a>
					</div>
